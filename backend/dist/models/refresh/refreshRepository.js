...
function saveRefresh(accountId, token) {
...
function getRefreshToken(token) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield refreshModel_1.default.findOne({ where: { token: token, revoked: false } });
    });
}
...
function deleteRefreshById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield refreshModel_1.default.destroy({ where: { userId: id } });
    });
}
exports.default = { saveRefresh, getRefreshToken, deleteByToken, deleteRefreshById };
